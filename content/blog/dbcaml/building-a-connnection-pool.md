...
So when I realized that I needed to rewrite the functionality for the pool, I reached out to [Leostera](https://twitter.com/leostera), the author of Riot, which is the core actor-model DBCaml uses to operate. I asked for help, and together we decided to study how the pool in Elixir's [Ecto](https://github.com/elixir-ecto/ecto) was implemented. This gave me a clearer understanding.
