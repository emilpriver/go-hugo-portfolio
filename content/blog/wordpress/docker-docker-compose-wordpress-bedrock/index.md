...
images: 
- https://cf-worker-cache.edgar-image.com/image?src=https://priver.dev/blog/wordpress/docker-docker-compose-wordpress-bedrock/cover.jpeg
published: true
...
![Docker](https://cf-worker-cache.edgar-image.com/image?src=https://priver.dev/blog/wordpress/docker-docker-compose-wordpress-bedrock/docker.png)
...
![Folder](https://cf-worker-cache.edgar-image.com/image?src=https://priver.dev/blog/wordpress/docker-docker-compose-wordpress-bedrock/folder.png)

Information about the folders
Config:
![Enviorment](https://cf-worker-cache.edgar-image.com/image?src=https://priver.dev/blog/wordpress/docker-docker-compose-wordpress-bedrock/config.png)

Web:

![Structure](https://cf-worker-cache.edgar-image.com/image?src=https://priver.dev/blog/wordpress/docker-docker-compose-wordpress-bedrock/docker.png)
